...
eurusd_d = pd.read_csv('eurusd_w.csv')
gbpusd_d = pd.read_csv('gbpusd_w.csv')
usdjpy_d = pd.read_csv('usdjpy_w.csv')
usdcad_d = pd.read_csv('usdcad_w.csv')
audusd_d = pd.read_csv('audusd_w.csv')
de_b = pd.read_csv('10dey_b_w.csv') 
us_b = pd.read_csv('10usy_b_w.csv')
jp_b = pd.read_csv('10jpy_b_w.csv')
ca_b = pd.read_csv('10cay_b_w.csv')
uk_b = pd.read_csv('10uky_b_w.csv')
au_b = pd.read_csv('10auy_b_w.csv')
